            ...
            <div className="p-6 bg-transparent text-white">
                ...
                <form className="flex flex-col items-center" onSubmit={handleSubmit}>
                    <div className="mb-8 relative">
                        ...
                        <input value={username} placeholder="Username" type="text" className="bg-transparent w-[340px] px-3 py-2 border-[2px] rounded-md text-white focus:outline-none focus:border-yellow-500 text-center" onChange={(e) => setName(e.target.value)} required />
                    </div>
                    <div className="mb-8 relative">
                        <EmailIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-yellow_default" />
                        <input value={email} placeholder="Email" type="email" className="bg-transparent w-[340px] px-3 py-2 border-[2px] rounded-md text-white focus:outline-none focus:border-yellow-500 text-center" onChange={(e) => setEmail(e.target.value)} required />
                    </div>
                    <div className="mb-8 relative">
                        <VpnKeyIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-yellow_default" />
                        <input value={password} placeholder="Password" type="password" className="bg-transparent w-[340px] px-3 py-2 border-[2px] rounded-md text-white focus:outline-none focus:border-yellow-500 text-center" onChange={(e) => setPassword(e.target.value)} required />
                    </div>
